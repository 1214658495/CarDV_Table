...
public class HMAlertDialog extends Dialog implements DialogInterface {

    public HMAlertDialog(Context context) {
        super(context);
    }

    public HMAlertDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public HMAlertDialog create() {
            ...
            final HMAlertDialog dialog = new HMAlertDialog(context, R.style.Dialog);
            View layout = inflater.inflate(R.layout.dialog_normal_layout, null);
            dialog.addContentView(layout, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams
                    .WRAP_CONTENT));
            ...
            if (null != positiveButtonText || null != negativeButtonText) {
                ...
                layout.findViewById(R.id.btn_grp).setVisibility(View.GONE);
            }
